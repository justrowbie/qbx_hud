...
RegisterNetEvent('hud:client:ShowAccounts', function(type, amount)
    if type == 'cash' then
        exports.qbx_core:Notify('Tunai', 'inform', 7500, 'Rp'..amount)
    else
        exports.qbx_core:Notify('Bank', 'inform', 7500, 'Rp'..amount)
    end
end)
...
RegisterNetEvent('hud:client:OnMoneyChange', function(type, amount, isMinus)
    ...
    if type == 'cash' then
        if isMinus then
            exports.qbx_core:Notify('Tunai Keluar', 'error', 7500, 'Rp'..amount)
        else
            exports.qbx_core:Notify('Tunai Masuk', 'success', 7500, 'Rp'..amount)
        end
    elseif type == 'bank' then
        if isMinus then
            exports.qbx_core:Notify('Bank Keluar', 'error', 7500, 'Rp'..amount)
        else
            exports.qbx_core:Notify('Bank Masuk', 'success', 7500, 'Rp'..amount)
        end
    end
end)
